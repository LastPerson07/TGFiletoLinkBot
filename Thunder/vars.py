...
class Var:
    ...
    NAME: str = os.getenv("NAME", "Netflixian X")
    SLEEP_THRESHOLD: int = int(os.getenv("SLEEP_THRESHOLD", "600"))
    WORKERS: int = int(os.getenv("WORKERS", "8"))

    BIN_CHANNEL: int = int(os.getenv("BIN_CHANNEL", "-1003656791142"))
    ...
    OWNER_ID: int = int(os.getenv("OWNER_ID", "8496419402"))
    ...
    force_channel_env = os.getenv("FORCE_CHANNEL_ID", "-1001557378145").strip()
